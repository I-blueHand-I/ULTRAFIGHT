...
public void GoldenPixel() {
  ...
  for (int i =0; i<2; i++) {
    int leftColor = get((PApplet.parseInt(players[i].xpos)-1 ), (PApplet.parseInt(players[i].ypos)+i));
    int rightColor = get((PApplet.parseInt(players[i].xpos + 20)), (PApplet.parseInt(players[i].ypos)+20+i));
...
class player {
  float xpos;
  float ypos;
  float dirX=5;//pour le MoveMaze
  float dirY=5; //pour le MoveMaze
  // pour le fight
