...
In 1974, when Maze War, the first online game had just been released, a bug took hold in all computer matrix. Two players were created: Blue and Red. For nearly forty years the two clashed in a relentless fight. These fights always ended up in a draw, until 2022, when they discovered the existence of the Golden Pixel. It was the source of an unlimited power. The legend says that René Descartes founded the Golden Pixel while he was building the pascaline. It was 300 years before the first computer was released. If one of the players grabbed the pixel, they could annihilate the other in a blink of an eye.
...
ULTRAFIGHT is a hand-made video game developed with Processing. The game is pretty simple. Two players are in the maze and they need to grab the Golden Pixel in the center and escape from the maze. If one of them grabs it and the other catches him, then an ULTRAFIGHT is triggered. It's a mini-game. There is a PONG, a DASH, and a FIGHT. If the player which grabbed the Golden Pixel wins the ULTRAFIGHT, then he will win the game. Otherwise, both players go back into the maze to fight again.
